...
{
	IOWR_32DIRECT(LCD_DMA_CONTROLLER_0_BASE, LCD_CONTROL_OFFSET, LCD_CONTROL_START_DMA);
}

void lcd_ack_transfer(void)
{
	IOWR_32DIRECT(LCD_DMA_CONTROLLER_0_BASE, LCD_CONTROL_OFFSET, LCD_CONTROL_ACK_IRQ);
}
